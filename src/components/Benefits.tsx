            ...
            <div className="container relative z-2">
                ...
                <div className="flex flex-wrap gap-10 mb-10">
                    {benefits.map((benefit) => (
                        <div
                            key={benefit.id}
                            className="block relative p-0.5 bg-no-repeat bg-[length:100%_100%] md:max-w-[24rem] lg:max-w-[22.5rem]"
                        ...
                        >
                            ...
                            <div className="absolute inset-0.5 bg-n-8" style={{ clipPath: "url(#benefits)" }}>
                                <div className="absolute inset-0 opacity-0 transition-opacity hover:opacity-10 duration-300">
                                    {benefit.imageUrl && (
                                        <img src={benefit.imageUrl} alt={benefit.title} width={380} height={362}
